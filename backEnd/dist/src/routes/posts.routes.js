...
postsRouter.get('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, connection_1.default('posts').select('*')];
            case 1:
                users = _a.sent();
...
postsRouter.get('/myPosts', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = request.user.id;
                return [4 /*yield*/, connection_1.default('posts').select('*').where('authorId', id)];
            case 1:
                users = _a.sent();
                return [2 /*return*/, response.json(users)];
        }
...
postsRouter.put('/:idPost', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var text, idPost, idUser, checkPostExists, authorId;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                text = request.body.text;
            ...
            case 1:
                ...
                return [4 /*yield*/, connection_1.default('posts').where('id', idPost).update('text', text)];
            case 2:
                _a.sent();
